...
const desktopApi: DesktopApi = {
  ...
  adminOps: {
    userSessions: async (payload) => ipcRenderer.invoke("desktop:admin-user-sessions", payload),
    revokeSession: async (payload) => ipcRenderer.invoke("desktop:admin-revoke-session", payload),
    userRelations: async (payload) => ipcRenderer.invoke("desktop:admin-user-relations", payload),
    removeFriend: async (payload) => ipcRenderer.invoke("desktop:admin-remove-friend", payload),
    setBlock: async (payload) => ipcRenderer.invoke("desktop:admin-set-block", payload),
    sendPasswordReset: async (payload) => ipcRenderer.invoke("desktop:admin-send-password-reset", payload),
    sendVerification: async (payload) => ipcRenderer.invoke("desktop:admin-send-verification", payload),
    banUser: async (payload) => ipcRenderer.invoke("desktop:admin-ban-user-detailed", payload),
    setDeletion: async (payload) => ipcRenderer.invoke("desktop:admin-set-deletion", payload),
    listAudit: async (payload) => ipcRenderer.invoke("desktop:admin-list-audit", payload),
    searchChat: async (payload) => ipcRenderer.invoke("desktop:admin-search-chat", payload),
    deleteChatMessage: async (payload) => ipcRenderer.invoke("desktop:admin-delete-chat-message", payload),
    redactChatMessage: async (payload) => ipcRenderer.invoke("desktop:admin-redact-chat-message", payload),
    purgeChat: async (payload) => ipcRenderer.invoke("desktop:admin-purge-chat", payload),
    removeChatReaction: async (payload) => ipcRenderer.invoke("desktop:admin-remove-chat-reaction", payload),
    listAttachments: async (payload) => ipcRenderer.invoke("desktop:admin-list-attachments", payload),
    deleteAttachment: async (payload) => ipcRenderer.invoke("desktop:admin-delete-attachment", payload),
    listReports: async (payload) => ipcRenderer.invoke("desktop:admin-list-reports", payload),
    updateReport: async (payload) => ipcRenderer.invoke("desktop:admin-update-report", payload),
    lobbyFeatures: async () => ipcRenderer.invoke("desktop:admin-lobby-features", {}),
    createLobby: async (payload) => ipcRenderer.invoke("desktop:admin-create-lobby", payload),
    deleteLobby: async (payload) => ipcRenderer.invoke("desktop:admin-delete-lobby", payload),
    transferLobby: async (payload) => ipcRenderer.invoke("desktop:admin-transfer-lobby", payload),
    moveMember: async (payload) => ipcRenderer.invoke("desktop:admin-move-member", payload),
    announce: async (payload) => ipcRenderer.invoke("desktop:admin-announce", payload),
    ...
    resetLeaderboard: async (payload) => ipcRenderer.invoke("desktop:admin-reset-leaderboard", payload),
    musicQueue: async (payload) => ipcRenderer.invoke("desktop:admin-music-queue", payload),
    clearMusicQueue: async (payload) => ipcRenderer.invoke("desktop:admin-clear-music-queue", payload),
    removeMusicTrack: async (payload) => ipcRenderer.invoke("desktop:admin-remove-music-track", payload),
    renameEmote: async (payload) => ipcRenderer.invoke("desktop:admin-rename-emote", payload),
